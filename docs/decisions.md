...
2026-07-03 | ГРАБЛЯ: на /transactions не должно быть блока итогов (доход/расход/остаток) — сам придумал, в макете его нет | пользователь поправил после ревью скриншота; итоги месяца остаются задачей дашборда (4), а не транзакций
2026-07-03 | Бренд в интерфейсе — "Финтрекер" (не "Fintrack") | так в макете; "Fintrack" — только кодовое/английское имя проекта из брифа
